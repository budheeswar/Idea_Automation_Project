...
public class WFSLoginPage {
	...
	public void navigateToIdeaMainPage() {
		webDriver.navigate().to(EnvironmentPropertyLoader.getPropertyByName("idea_wfs_main_page"));
		Reporter.log("Navigated to Idea WFS Main Page");
		reportGenerator.logMessage("Navigated to Idea WFS Main Page", Status.PASS);
	}
