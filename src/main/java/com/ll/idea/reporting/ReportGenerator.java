...
public class ReportGenerator {
	...
	private static final String BASE_REPORT_DIR = System.getProperty("user.dir") + File.separator
			+ ConfigPropertyLoader.getConfigValue("reportFolder");
	...
	public void setupExtendedReport(String testCaseNumber, String testMethodName) {
		...
		String htmlFilePath = reportPath + File.separator + testMethodName + "_"
				+ CalendarDateHandler.getFormatedDate("MMddyyyyhh_mm_ss") + ".html";
	 ...
	 * @param logLevel logLevel could be one of the following values such as PASS,
	 *                 FAIL, FATAL,ERROR, WARNING, INFO, DEBUG, SKIP
	 */
	...
	public void logAndCaptureScreen(String message, String methodName, Status logLevel, WebDriver webDriver) {
		...
		if (System.getProperty("isScreenShot").equalsIgnoreCase("True")) { // if isScreenShot value is false, then
																			// ignore screen shot
	...
	private void captureScreenShot(WebDriver webDriver, String methodName) {
		String destinationFileName = reportPath + File.separator + methodName + "-"
				+ CalendarDateHandler.getFormatedDate("MMddYYYYhhmmss") + ".png";
		if (webDriver != null) {
	...
	public void captureScreenshotByRobot(WebDriver webDriver, String methodName) {
		String destinationFileName = reportPath + File.separator + methodName + "-"
				+ CalendarDateHandler.getFormatedDate("MMddYYYYhhmmss") + ".png";
